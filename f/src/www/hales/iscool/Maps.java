...
public class Maps implements LocationListener {
    ...
    private String id="000000"; //for now using one user id (fix when login works)
    ...
    public void updateCustomerLocation(String runId,String userId,int loc)
    {
        ConnectionRequest req=new ConnectionRequest();
        String inputUrl="https://crippin-coffee.herokuapp.com/updateCustomerLocation?runId=le8njtu4ixhu&userId=000000&loc=10";
        String newinput = inputUrl+"?runID="+runId+"&userId="+userId+"&loc="+loc;
